    ...
    <div class="rangepicker__calendar">
      <div class="rangepicker__month-indicator">
        <div class="rangepicker__selector-controls">
          <base-button class="rangepicker__selector-control-left" @click="selectMonth('prev')" />
          <div>{{selectedDate}}</div>
          <base-button class="rangepicker__selector-control-right" @click="selectMonth('next')" />
        </div>
      </div>
      <div class="rangepicker__date-grid">
        <div v-for="day in calendarLeaf" :key="day.id"
          ...
          <div>{{day.date}}</div>
          <div v-if="day.events">
            <a v-for="event in day.events" :key="event.id" class="rangepicker__event">{{event.title}}</a>
          </div>
        </div>
      </div>
    </div>
